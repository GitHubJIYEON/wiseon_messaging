...
const MOCK_ADDRESS_GROUPS: AddressGroup[] = [
  {
    ...
    contacts: [
      { id: "c1", name: "김영희", phone: "010-1234-5678", company: "ABC주식회사" },
  ...
  },
  {
    ...
    contacts: [
      { id: "c6", name: "한소희", phone: "010-6666-7777", company: "MNO주식회사" },
  ...
  },
  {
    ...
    contacts: [
      { id: "c10", name: "임태양", phone: "010-7777-8888", company: "STU파트너스" },
      { id: "c11", name: "배하늘", phone: "010-0000-1234", company: "VWX컨설팅" },
    ],
  },
];
            ...
            {filteredGroups.map((group) => {
              ...
              return (
                <li key={group.id}>
                  ...
                  {isExpanded && (
                    <div className="border-t border-gray-100 bg-point-gray-100 px-4 py-2">
          ...
          {groups
            ...
            .map((g) => (
              <button
                ...
                className="group flex cursor-pointer items-center gap-1 rounded-full border border-primary-200 bg-primary-50 px-2.5 py-1 text-[12px] text-primary transition-colors hover:border-danger-500 hover:bg-danger-500/5"
              >
                <FolderIcon size={11} />
                {g.name}
